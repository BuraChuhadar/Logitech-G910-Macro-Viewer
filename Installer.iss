...
#define MyAppName "G910 Macro Viewer"
#define MyAppVersion "1.0.0"
#define MyAppPublisher "Bura Chuhadar"
#define MyAppExeName "G910 Macro Viewer.exe"
...
OutputBaseFilename=G910 Macro Viewer
Compression=lzma
...
Source: "bin\Release\net7.0-windows\G910 Macro Viewer.deps.json"; DestDir: "{app}"; Flags: ignoreversion
Source: "bin\Release\net7.0-windows\G910 Macro Viewer.dll"; DestDir: "{app}"; Flags: ignoreversion
Source: "bin\Release\net7.0-windows\G910 Macro Viewer.runtimeconfig.json"; DestDir: "{app}"; Flags: ignoreversion
